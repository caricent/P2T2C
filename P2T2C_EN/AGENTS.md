# AGENTS.md — P2T2C AI Operational Entry
...
1. `AGENTS.md`
2. `project_config.yaml`; if missing, read `project_config.example.yaml`
...
|---|---|---|
| Initialize repository | `prompts/01_bootstrap_repository_prompt.md` | Yes, skeleton only |
| Generate Change Pack | `prompts/02_generate_change_pack_prompt.md` | No |
| Apply Change Pack | `prompts/03_apply_change_pack_prompt.md` | Yes, only after Gate A |
| Generate Execution Pack | `prompts/04_generate_execution_pack_prompt.md` | Yes |
| Execute single task | `prompts/05_execute_single_task_prompt.md` | Yes, one task only |
| Acceptance and Closure | `prompts/06_acceptance_and_closure_prompt.md` | Yes, execution docs only unless Truth Drift pauses |

Stage-specific reads:

- Change Pack: current CP, related SoT / ADR, `templates/change_pack/CHANGE_PACK_TEMPLATE.md`
- Apply Change Pack: approved Change Pack, related SoT / ADR, truth templates, `docs/sot/manifest.yaml`
- Execution Pack: related CP / SoT / ADR, `sdd/templates/spec.md`, `sdd/templates/plan.md`, `sdd/templates/tasks.md`
...
- Install / upgrade: `README.md`, install or upgrade script, `.p2t2c/ownership.yaml`
...
- Do not put business rules in `AGENTS.md`, `.agents/rules/`, prompts, tests, code comments, or navigation files.
